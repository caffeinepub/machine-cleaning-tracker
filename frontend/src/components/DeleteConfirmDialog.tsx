...
export function DeleteConfirmDialog({ machine, open, onOpenChange }: DeleteConfirmDialogProps) {
        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Are you sure you want to delete <strong className="text-foreground">{machine.name}</strong>?
                        This action cannot be undone and all cleaning history will be lost.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    ...
                    >
                        {deleteMachine.isPending && <Loader2 className="w-4 h-4 animate-spin" />}
                        Delete Machine
                    </AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
