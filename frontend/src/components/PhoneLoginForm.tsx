...
export function PhoneLoginForm({ onForgotPassword }: PhoneLoginFormProps) {
    ...
    if (success) {
        return (
            <div className="flex flex-col items-center gap-2 py-3 text-center">
                ...
                <p className="font-semibold text-foreground text-sm">Logged in successfully!</p>
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-3" noValidate>
            ...
            <Button type="submit" className="w-full gap-1.5 font-semibold" disabled={isLoading}>
                {isLoading ? (
                    <>
