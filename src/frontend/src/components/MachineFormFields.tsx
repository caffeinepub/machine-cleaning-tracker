    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <Select
          ...
          onValueChange={(val) =>
            onChange({ ...data, machinePart: val as MachinePart })
          }
        >
          ...
          <SelectContent>
            ...
            <SelectItem value={MachinePart.mistUnit}>Mist Unit</SelectItem>
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          onChange={(e) =>
            onChange({ ...data, lastCleaningDone: e.target.value })
          }
          className="font-medium"
        />
      </div>
...
export function validateMachineForm(data: MachineFormData): string | null {
  ...
  if (data.nextDue < data.lastCleaningDone)
    return "Next due date cannot be before the last cleaned date.";
  return null;
}
