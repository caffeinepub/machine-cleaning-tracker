...
import { useGetCallerUserProfile, useSaveContact } from "../hooks/useQueries";
...
export function AddContactDetailsPage({
  onComplete,
  userName,
}: AddContactDetailsPageProps) {
          ...
          <Card className="border-border shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-xs">
                Fill in your contact information. You can skip this step if you
                prefer.
              </CardDescription>
            </CardHeader>
            <CardContent>
